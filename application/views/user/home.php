...
<?php foreach($karyawan as $k){ ?>
		<div id="colorlib-main">
			<section id="colorlib-hero" class="js-fullheight" data-section="home">
				<div class="flexslider js-fullheight">
					<ul class="slides">
				   	<li style="background-image: url(<?php echo base_url()?>user/images/img_bg_1.jpg);">
					   			...
					   			<div class="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text">
					   				<div class="slider-text-inner js-fullheight">
					   					<div class="desc">
						   					...
						   					<h2>This is the main page of your profile <br> you can learn with the material that we have provided and also you can read the post that we have published </h2>
											</div>
					   				</div>
					   			</div>
					   		</div>
				   	...
				   	<li style="background-image: url(<?php echo base_url()?>user/images/img_bg_2.jpg);">
				   		<div class="overlay"></div>
				   		<div class="container-fluid">
				   			<div class="row">
					   			<div class="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="col-md-6 animate-box" data-animate-effect="fadeInBottom">
								<p>
									<strong>Nama</strong> : <?php echo $k->nama; ?><br>
									<strong>Nomor Karyawan</strong> : <?php echo $k->nmr; ?><br>
									<strong>Unit</strong> : <?php echo $k->unit; ?><br>
									<strong>Posisi</strong> : <?php echo $k->posisi; ?><br>
									<strong>Pengalaman</strong> : <?php echo $k->pnglman; ?><br>
									<strong>Email</strong> : <?php echo $k->email; ?><br>
									<strong>No. Handphone</strong> : <?php echo $k->nohp; ?><br>
									<strong>No. Telepon</strong> : <?php echo $k->notlp; ?>
								</p>
							</div>
							<div class="col-md-6 animate-box" data-animate-effect="fadeInBottom">
								<p>
									<strong>Alamat</strong> : <?php echo $k->alamat; ?><br>
									<strong>TTL</strong> : <?php echo $k->tmptlhr.", ".$k->tgllhr; ?><br>
									<strong>Kodepos</strong> : <?php echo $k->kodepos; ?><br>
									<strong>Jenis Kelamin</strong> : <?php echo $k->gender; ?><br>
									<strong>Agama</strong> : <?php echo $k->agama; ?><br>
									<strong>Pendidikan</strong> : <?php echo $k->pnddkn; ?><br>
									<strong>Hobby</strong> : <?php echo $k->hobby; ?><br>
									<strong>Status</strong> : <?php echo $k->status; ?><br>
									<strong>Jumlah Keluarga</strong> : <?php echo $k->jmlhkeluarga; ?><br>
									<strong>BPJS</strong> : <?php echo $k->bpjs; ?><br>
									<strong>No. Rekening</strong> : <?php echo $k->rekening; ?>
								</p>
							</div>
								</div>
								</div>
							...
							<div class="row">
								<div class="col-md-12 animate-box" data-animate-effect="fadeInLeft">
									<div class="hire" align="center">
										<a href="#" class="btn-hire">Edit Profile</a>
									</div>
								</div>
							</div>
						</div>
	...
	<!-- Flexslider -->
	<script src="<?php echo base_url()?>user/js/jquery.flexslider-min.js"></script>
	<!-- Owl carousel -->
	<script src="<?php echo base_url()?>user/js/owl.carousel.min.js"></script>
	<!-- Counters -->
	<script src="<?php echo base_url()?>user/js/jquery.countTo.js"></script>
